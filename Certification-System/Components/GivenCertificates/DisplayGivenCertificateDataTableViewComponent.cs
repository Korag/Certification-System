...
{
    public class DisplayGivenCertificateDataTableViewComponent : ViewComponent
    {
        public IViewComponentResult Invoke(ICollection<DisplayGivenCertificateViewModel> givenCertificateViewModel, string tableIdentificator, int operationSet = 0)
        {
            ...
            return View("_DisplayGivenCertificateDataTable", givenCertificateDataTableViewModel);
        }
    }
}
