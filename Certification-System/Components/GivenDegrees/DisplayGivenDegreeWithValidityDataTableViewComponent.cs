...
{
    public class DisplayGivenDegreeWithValidityDataTableViewComponent : ViewComponent
    {
        public IViewComponentResult Invoke(ICollection<DisplayGivenDegreeViewModel> givenDegreeViewModel, string tableIdentificator, int operationSet = 0)
        {
            ...
            return View("_DisplayGivenDegreeWithValidityDataTable", givenDegreeDataTableViewModel);
        }
    }
}
